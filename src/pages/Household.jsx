...
import { Users, Plus, Pencil, Trash2, Home, X } from 'lucide-react'
...
export default function Household() {
  const { contributors, householdExpenses, loading, fetch, createContributor, updateContributor, deleteContributor } = useHouseholdStore()
